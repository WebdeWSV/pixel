...
$subject = 'Футболка Мужская Пиксель Дима'; // заголовок письмя
$addressat = "vova.svurudenko@gmail.com"; // Ваш Электронный адрес
$success_url = './form.php?name='.$_POST['name'].'&phone='.$_POST['phone'].'&time='.$_POST['Время_звонка'].'';
